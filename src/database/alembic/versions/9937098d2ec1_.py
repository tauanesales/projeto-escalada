...
def upgrade() -> None:
    ...
    sa.Column('tipo_usuario', sa.Enum('ADMIN', 'PADRAO', name='tipousuarioenum'), nullable=False),
    ...
    op.create_index(op.f('ix_autor_musica_papel'), 'autor_musica', ['papel'], unique=False)
    ...
    op.create_index(op.f('ix_avisos_criador_id'), 'avisos', ['criador_id'], unique=False)
    ...
    op.create_table('gerar_acesso_admin',
    ...
    op.create_index(op.f('ix_gerar_acesso_admin_criador_id'), 'gerar_acesso_admin', ['criador_id'], unique=False)
    op.create_index(op.f('ix_gerar_acesso_admin_id'), 'gerar_acesso_admin', ['id'], unique=False)
    op.create_index(op.f('ix_gerar_acesso_admin_token'), 'gerar_acesso_admin', ['token'], unique=True)
    op.create_table('historico_edicoes_dashboard',
    ...
    op.create_index(op.f('ix_historico_edicoes_dashboard_editor_id'), 'historico_edicoes_dashboard', ['editor_id'], unique=False)
    op.create_index(op.f('ix_historico_edicoes_dashboard_id'), 'historico_edicoes_dashboard', ['id'], unique=False)
    ...
    op.create_table('solicitacoes_de_musica',
    sa.Column('solicitante_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('PENDENTE', 'ACEITA', 'RECUSADA', name='statussolicitacaodemusicaenum'), nullable=False),
    sa.Column('tipo_solicitacao', sa.Enum('CRIAR', 'ATUALIZAR', 'REMOVER', name='tiposolicitacaodemusicaenum'), nullable=False),
    ...
    sa.Column('atualizado_em', sa.DateTime(), nullable=False),
    sa.Column('deletado_em', sa.DateTime(), nullable=True),
    sa.CheckConstraint('(avaliador_id IS NOT NULL AND avaliado_em IS NOT NULL) OR (avaliador_id IS NULL AND avaliado_em IS NULL)', name='check_avaliador_and_avaliado_em'),
    sa.ForeignKeyConstraint(['avaliador_id'], ['usuarios.id'], ),
    sa.ForeignKeyConstraint(['solicitante_id'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_solicitacoes_de_musica_id'), 'solicitacoes_de_musica', ['id'], unique=False)
    op.create_table('foto_historico_edicoes_dashboard',
    ...
    sa.ForeignKeyConstraint(['historico_edicao_dashboard_id'], ['historico_edicoes_dashboard.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_foto_historico_edicoes_dashboard_id'), 'foto_historico_edicoes_dashboard', ['id'], unique=False)
    op.create_table('usuario_foto',
    sa.Column('usuario_id', sa.Integer(), nullable=False),
    sa.Column('foto_id', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_foto_historico_edicoes_dashboard_id'), table_name='foto_historico_edicoes_dashboard')
    op.drop_table('foto_historico_edicoes_dashboard')
    op.drop_index(op.f('ix_solicitacoes_de_musica_id'), table_name='solicitacoes_de_musica')
    ...
    op.drop_index(op.f('ix_historico_edicoes_dashboard_id'), table_name='historico_edicoes_dashboard')
    op.drop_index(op.f('ix_historico_edicoes_dashboard_editor_id'), table_name='historico_edicoes_dashboard')
    ...
    op.drop_index(op.f('ix_gerar_acesso_admin_criador_id'), table_name='gerar_acesso_admin')
